...
<div id="content-wrapper">
    ...
    <div id="content">
        ...
        <div>
            ...
            <hr>
            <img src="../images/Bildsw.jpg" alt="Birgit Brenner" style="float:right; padding: 15px;"/>
            ...
            <div>
                ...
                <div class="imagestyleetikette">
                    ...
                    <div style="margin-left: 20px;">
                        ... das Bild, das wir nach au�en abgeben
                    </div>
                    <div>
                        <b>
                            Style
                ...
                <br/>
                <br/>
                 "F�r den ersten Eindruck gibt es keine zweite Chance"
                <br/>
                <br/>
                Wir unterst�tzen Sie mit unserer individuellen Beratung nicht nur mit dem ersten Eindruck zu begeistern sondern durch ein souver�nes Auftreten im Ganzen zu �berzeugen!
                <br/>
                <br/>
